...
var elements = Tree.parse({
    group: {
        style: { orientation: 'row', alignChildren: ['', 'top'] },
        panel1: {
            button: [, , 'BTN'],
        },
        panel2: {
            style: { alignChildren: ['left', 'top'], spacing: 5, orientation: 'column' },
            checkbox1: [, , '锚点居中'],
            checkbox2: [, , '逐字预合成'],
            panel1: {
                param: ['offseGroup1'],
                style: { spacing: 0, margins: [20, 0, 0, 7], orientation: 'column', alignChildren: ['left', ''] },
                checkbox: [, , '相同字符同源'],
                panel: {
                    style: { spacing: 0, orientation: 'row' },
                    statictext: [, , '边界大小'],
                    edittext: [],
                },
            },
            checkbox3: [, , '合并临界点'],
            panel2: {
                style: { spacing: 0, margins: 0, orientation: 'column', alignChildren: ['left', ''] },
                param: ['offseGroup2'],
                group1: {
                    radiobutton2: [, [0, 7, 50, 22], '自动'],
                    edittext: [],
                },
                group2: {
                    radiobutton2: [, [0, 7, 50, 22], '阈值'],
                    edittext: [],
                },
            },2
        },
